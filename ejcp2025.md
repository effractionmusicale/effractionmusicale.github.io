...
L'instrument Kisana va nous permettre de décrouvrir une autre technique de synthèse sonore, l'algoritme de Karplus et Strong le plus simple des modèles physiques.
