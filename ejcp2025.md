...
### Demander la génération de la documentation mathématique et donner le pdf généré à son IA favorite avec le prompt suivant :

Cette documentation est destinée à « préserver » un programme Faust en donnant les équations mathématiques. L'idée est que ces équations mathématiques seront encore compréhensibles dans 500 ans alors que le langage Faust aura disparu. Peux-tu me dire (sans regarder le programme Faust lui-même, et en ne te basant que sur les équations et le texte d'explication) si tu pourrais réimplémenter ce programme dans un autre langage de programmation et si les équations mathématiques sont claires ?
